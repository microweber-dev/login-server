<ul class="idp-list">
    ...
    @endif
    @if (in_array('facebook', config('authv.socialite')) && !empty(env('FACEBOOK_CLIENT_ID')))
        <li class="idp-list-item">
    ...
    @endif
    @if (in_array('twitter', config('authv.socialite')) && !empty(env('TWITTER_CLIENT_ID')))
        <li class="idp-list-item">
    ...
    @endif
    @if (in_array('linkedin', config('authv.socialite')) && !empty(env('LINKEDIN_CLIENT_ID')))
        <li class="idp-list-item">
    ...
    @if (in_array('github', config('authv.socialite')) && !empty(env('GITHUB_CLIENT_ID')))
        <li class="idp-list-item">
    ...
    @endif
    @if (in_array('bitbucket', config('authv.socialite')) && !empty(env('GITHUB_CLIENT_ID')))
        <li class="idp-list-item">
