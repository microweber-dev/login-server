...
@section('content')
    ...
    <div class="container text-center">
        <div class="login-holder">
            ...
            <br />
            <h4>{{trans('all.choose_an_account')}}</h4>
            <p>
                {{ trans('all.to_continue_to') }} <span class="text-primary">{{$redirectDomain}}</span> </p>
            <br>
            ...
            <form class="form-vertical" role="form" method="POST" action="">
                    ...
                    <ul class="list-group list-group-flush select-account"  style="text-align: left;">
                        ...
                        <li class="list-group-item" onclick="useAnotherAccount()">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3 ml-3">
                                    <b> {{trans('all.use_another_account')}}</b> <br />
                                    {{trans('all.login_into_another_account')}}
                                </div>
                            </div>
                        </li>
                    </ul>
                ...
                <br />
                <p>
                {!! trans('all.data_policy_ask_to_auth') !!} <b>{{$redirectDomain}}</b>.
                </p>
            </form>
        </div>
